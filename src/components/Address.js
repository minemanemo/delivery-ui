...
class Address extends Component {
  ...
  scrollHandler = {
    ...
    lock: () => {
      ...
      window.addEventListener('scroll', this.scrollHandler.noScroll);
    },
    unlock: () => {
      document.querySelector('body').classList.remove('no-scroll');
      window.removeEventListener('scroll', this.scrollHandler.noScroll);
    },
  };
  ...
  render() {
    ...
    return (
      <Wrapper>
        <ToolBox>
          <Title>등록된 배송지</Title>
          <AddButton onClick={showAddWindow}>+ 추가</AddButton>
        </ToolBox>
        <Contents>
          <AddressList
            addresses={addresses}
            ...
            deleteAddress={showDeleteWindow}
          />
          <MostQuestion />
        </Contents>
        <ModalWindow
